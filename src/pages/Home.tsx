        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[70vh]">
          ...
          >
            <div className="relative">
              ...
              <motion.div
                className="absolute -top-14 -left-8 p-4 rounded-xl bg-card border border-border font-code text-sm"
                animate={{ y: [0, -10, 0] }}
              ...
              <motion.div
                className="absolute -bottom-14 -right-4 p-4 rounded-xl bg-card border border-border font-code text-sm"
                animate={{ y: [0, 10, 0] }}
